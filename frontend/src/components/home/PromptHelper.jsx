      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-between sm:items-center">
            <button onClick={handleAnalyzeText} className="bg-primary-50 text-primary-700 font-bold hover:bg-primary-100 px-4 sm:px-6 py-3 rounded-xl transition-colors text-sm w-full sm:w-auto">
              تحليل النص واستخراج البيانات
            </button>

            {suggestion && (
              <button onClick={executeSearch} className="bg-slate-900 text-white px-6 sm:px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition-all flex items-center justify-center gap-2 w-full sm:w-auto">
